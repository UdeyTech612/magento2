 ...
 */
class LookbookNight extends Template
{
    /**
     * @var string
     */
    protected $_template = 'lookbook/product_tab_formnight.phtml';
    /**
     * @var Registry
     */
    protected $_registry;
    ...
    public function getItemPositions($item_id)
    {
        $collection = $this->_collectionFactory->create()
            ...
            ->addFieldToFilter('type', 'night')->getLastItem();
        return $collection;
    }
