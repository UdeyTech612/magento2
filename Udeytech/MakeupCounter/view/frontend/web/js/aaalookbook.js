    ...
    return function (data, node) {
        var LookBook = {
            ...
            lookBookMarkers: function () {
                this.lookIndex = data.lookBookMarkers;
                this.look = $('#lookbook_' + this.lookIndex);
                this.lookImg = $('#lookImg_' + this.lookIndex);
                this.init = function () {
                    var that = this;
                ...
                this.repositionElements = function () {
                    ...
                    this.getGroupPluses().each(function () {
                        ...
                        var newX = that.getPositionX(productId) * $img.width() - ($el.width() / 2);
                        var newY = that.getPositionY(productId) * $img.height() - ($el.height() / 2);
            ...
            sktData: function () {
                ...
                this.allAssociatedProducts = JSON.parse('{"productId":44,"productId":45,"productId":46}');
                var that = this;
            ...
            updateLook: function () {
                ...
                $(this.lookBooks[that.currentLookIndex]).trigger('updateLook');
            },
