...
namespace Udeytech\MakeupCounter\Block\Adminhtml\Tab;
...
/**
 * Class Productgrid
 * @package Udeytech\MakeupCounter\Block\Adminhtml\Tab
 */
class Productgrid extends Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productFactory->create()->getCollection()->addAttributeToSelect('sku')->addAttributeToSelect(
            'name')->addAttributeToSelect('attribute_set_id')->addAttributeToSelect('type_id')->setStore($store);
