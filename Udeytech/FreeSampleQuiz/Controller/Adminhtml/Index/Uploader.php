...
namespace Udeytech\FreeSampleQuiz\Controller\Adminhtml\Index;
...
/**
 * Class Uploader
 * @package Udeytech\FreeSampleQuiz\Controller\Adminhtml\Index
 */
class Uploader extends Action
{
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name', 'thumb');
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'thumb/image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'thumb/image/' . $firstName . '/' . $secondName . '/';
            ...
            $imageResult['url'] = $mediaUrl . 'thumb/image/' . $firstName . '/' . $secondName . '/' . $newImageName;
        } catch (Exception $e) {
