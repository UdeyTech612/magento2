...
class Index extends Action {
    ...
    public function execute() {
        ...
        $this->loadLayout();
        $this->_initLayoutMessages('customer/session')->_initLayoutMessages('catalog/session')
            ->_initLayoutMessages('checkout/session');
        $this->renderLayout();
        //return $this->resultPageFactory->create();
    }
    protected function registerDefault($product){
        $expertKits = $this->_helper()->getKitCollection($product);
