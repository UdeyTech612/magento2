...
define([
    ...
    $.widget('mage.dsFaqWidgetDynamicRows', {
        tableBody: $(),
        template: {},
        elements: null,
        elementsModels: {},
        ...
        addInsertRowsListener: function () {
            $(document).on('dsDynamicRowsAdd' + this.options.uniqId, this.addNewRowsCallback.bind(this));
        },
        ...
        triggerUpdateEvent: function () {
            ...
            $(document).trigger('dsDynamicRowsUpdated' + this.options.uniqId, {'elements': eventData});
        },
    ...
    return $.mage.dsFaqWidgetDynamicRows;
});
